    ...
    <div className="screen-in" style={{ paddingBottom: 120, position: 'relative' }}>
      ...
      <div style={{ padding: '12px 24px 24px', position: 'relative', zIndex: 2 }}>
        <div style={{ width: 110, height: 110, borderRadius: 22, overflow: 'hidden', boxShadow: '0 20px 50px rgba(0,0,0,0.5)' }}>
          <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&q=80" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </div>
      ...
      {tab === 'playlists' && (
        <div style={{ padding: 20, display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 14 }}>
          {[
            { name: 'Rainy Day Sonnets', count: '18 poems · 42m', img: 'https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?w=400&q=80' },
            { name: 'Midnight Monologues', count: '24 poems · 1h 12m', img: 'https://images.unsplash.com/photo-1532767153582-b1a0e5145009?w=400&q=80' },
            { name: 'Classical Reimagined', count: '12 poems · 38m', img: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=400&q=80' },
            { name: 'Urban Solitude', count: '31 poems · 54m', img: 'https://images.unsplash.com/photo-1444723121867-7a241cacace9?w=400&q=80' },
          ].map(pl => (
