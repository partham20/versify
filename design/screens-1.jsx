...
function CommentsView({ poem, onBack }) {
  ...
  const submit = () => {
    if (!text.trim()) return;
    setComments([{ id: 'c' + Date.now(), author: 'You', handle: '@you', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&q=80', time: 'now', body: text, likes: 0, replies: 0 }, ...comments]);
    setText('');
  };
  return (
